...
export const ui: Record<Locale, UiStrings> = {
  en: {
    ...
    sections: {
      work: { label: 'Selected Work', title: 'Projects that show how I think and build.', viewProject: 'View project', liveDemo: 'Live Demo', github: 'GitHub', technologies: 'Technologies', imagePlaceholder: 'image placeholder', addImage: 'Add project image' },
  ...
  uk: {
    ...
    sections: {
      work: { label: 'Вибрані проєкти', title: 'Проєкти, що показують, як я думаю та будую.', viewProject: 'Переглянути', liveDemo: 'Демо', github: 'GitHub', technologies: 'Технології', imagePlaceholder: 'зображення-заглушка', addImage: 'Додати зображення проєкту' },
